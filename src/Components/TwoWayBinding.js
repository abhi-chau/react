        ...
        <div className="container">
          <div className="row">
            <div className="col-3">
                ...
                <dl>
                    <dt>Name</dt>
                    <dd><input className="form-cntrol" onChange={handleName} type="text"/></dd>
                    <dt>Price</dt>
                    ...
                    <dt>Stock</dt>
                    <dd className="form-switch"><input onChange={handleStock} className="form-check-input" type="checkbox"></input>Available</dd>
                </dl>
