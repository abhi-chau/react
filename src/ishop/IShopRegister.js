...
export default function IShopRegister()
{
    ...
    const formik = useFormik({
      ...
      onSubmit:values=>{
        axios.post("http://127.0.0.1:8080/registeruser",values);
     ...
     <div>
        ...
        <form onSubmit={formik.handleSubmit}>
            <dl>
                ...
                <dt>Password</dt>
                <dd><input type="text" value={formik.values.Password} onChange={formik.handleChange} name="Password"/></dd>
                <dt>Age</dt>
                ...
                <dt>Subscription</dt>
                <dd className="form-switch"><input className="form-check-input" type="checkbox" checked={formik.values.Subscribed} onChange={formik.handleChange} name="UserId"/>Yes</dd>
            </dl>
